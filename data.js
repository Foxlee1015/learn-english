export const verbs = {
  ...
  fill: {
    up: ["To fill something completely.", ["Bruce filled up his wine glass."]],
  },
  find: {
  ...
  think: {
    over: ["To consider something.", ["Yosef thought over Rosie’s situation."]],
  },
  throw: {
    away: ["To dispose of something.", ["Could you throw away that burrito?"]],
  },
  top: {
